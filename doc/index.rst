...
* **INIT_SCRIPT** (default: not set): Used to specify shell commands that run before any other commands. See more `here <./index.rst#run-pre-post-process-custom-commands>`__.
